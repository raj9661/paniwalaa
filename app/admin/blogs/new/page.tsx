...
import { Droplet, Save, ArrowLeft, Eye, TrendingUp, FileText } from 'lucide-react'
...
export default function NewBlogPostPage() {
  ...
  useEffect(() => {
    // Auto-generate OG title from meta title if empty
    if (formData.metaTitle && !formData.ogTitle) {
      setFormData((prev) => ({ ...prev, ogTitle: formData.metaTitle }))
    }
  }, [formData.metaTitle])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Create & Optimize Content</p>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <Breadcrumb items={[{ label: 'Blogs & SEO', href: '/admin/blogs' }, { label: 'New Post' }]} className="mb-6" />
